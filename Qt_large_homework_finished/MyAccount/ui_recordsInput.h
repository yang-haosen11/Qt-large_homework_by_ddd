...
public:
    ...
    void setupUi(QWidget *recordsInput)
    {
        ...
        recordType->setGeometry(QRect(190, 170, 150, 22));
        recordType->setStyleSheet(QString::fromUtf8("background-color: rgb(173, 216, 230);\n"
        ...
        recordAmount->setStyleSheet(QString::fromUtf8("background-color: rgb(173, 216, 230);"));
    ...
    void retranslateUi(QWidget *recordsInput)
    {
        ...
        recordType->setItemText(2, QCoreApplication::translate("recordsInput", "TransportCosts", nullptr));
        recordType->setItemText(3, QCoreApplication::translate("recordsInput", "NecessityCosts", nullptr));
        recordType->setItemText(4, QCoreApplication::translate("recordsInput", "MedicalCosts", nullptr));
        recordType->setItemText(5, QCoreApplication::translate("recordsInput", "BookCosts", nullptr));
        recordType->setItemText(6, QCoreApplication::translate("recordsInput", "GiftCosts", nullptr));
        recordType->setItemText(7, QCoreApplication::translate("recordsInput", "TravelCosts", nullptr));
        recordType->setItemText(8, QCoreApplication::translate("recordsInput", "DressCosts", nullptr));
        recordType->setItemText(9, QCoreApplication::translate("recordsInput", "DigitalCosts", nullptr));
        recordType->setItemText(11, QCoreApplication::translate("recordsInput", "SubscribeCosts", nullptr));
