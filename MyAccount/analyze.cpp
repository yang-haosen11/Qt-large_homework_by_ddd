...
Analyze::Analyze(QWidget *parent,Menu* menu):QMainWindow(parent),file("text.txt"),ui(new Ui::Analyze),currentSeries(nullptr),currentChartView(nullptr),scrollArea(nullptr),label(nullptr),menuWindow(menu)
{
    AIresult = nullptr;
    question.clear();
    ui->setupUi(this);
